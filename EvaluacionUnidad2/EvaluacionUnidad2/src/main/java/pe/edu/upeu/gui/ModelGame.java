...
public class ModelGame {
    ...
    public void marcarCasilla(int i, int j, JLabel[][] casillas, Juega3enRaya view) {
    ...
    private void terminarJuego(Juega3enRaya view) {
        if (draw) {
            ResultadoTO to = view.uTO;
    ...
    void AnularGame(JLabel[][] casillas,Juega3enRaya view) {
        turno = "X";
        end = false;
        draw = false;
        cantMovidas = 0;
